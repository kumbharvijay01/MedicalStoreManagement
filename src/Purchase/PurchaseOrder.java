...
public class PurchaseOrder extends javax.swing.JInternalFrame {
  ...
  //  int rowcount,columncount;
    ...
    //public String product_id,productname,productCategory;
    ResultSet rs_1;
    String searchteaxt;
    ...
    public PurchaseOrder(JFrame parent, boolean modal) {
        initComponents();
        conn=new Dbconn();
 ...
 public void refreshTable(String temp_id)
    {
          ...
          rs_Distributor=conn.execute_query("select * from product_info where productstatus=? and distributors_id=?", new String[]{"ACTIVE",temp_id});
    ...
    private void initComponents() {
        ...
        jdistnamecombo = new javax.swing.JComboBox();
        ...
        jdistnamecombo.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        jdistnamecombo.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                jdistnamecomboPopupMenuWillBecomeInvisible(evt);
            }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jdistmobileno, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jdistOfficeno, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jpdistorderno, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                        .addGap(32, 32, 32)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jdistnamecombo, 0, 134, Short.MAX_VALUE)
                                .addGap(87, 87, 87))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jpdistemailid, javax.swing.GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)
                                .addGap(43, 43, 43)))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel1)
                    .addComponent(jdistnamecombo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        EditButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/updateicon.png"))); // NOI18N
        ...
        jDisttableproductllist.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Product Name", "Category", "Exp. Date", "Min Stock", "Rate Per Unit", "Total Stock"
            }
        ));
...
public void printmessage()
{
    ...
    private void jdistnamecomboPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_jdistnamecomboPopupMenuWillBecomeInvisible
String temp=jdistnamecombo.getSelectedItem().toString();
System.out.println(temp);
    ResultSet rs;
    
    try
    {
        rs=conn.execute_query("select * from distributors_details where distributors_name=?", new String[]{temp});
        while(rs.next())
        {
            distid=rs.getString("distributors_id");
            dist_add=rs.getString("distributors_address");
            dist_officeno=rs.getString("distributors_officeno");
            dist_mobileno=rs.getString("distributors_mobileno");
            dist_emailid=rs.getString("distributors_email");
            
            jpdistAddress.setText(dist_add);
            jpdistemailid.setText(dist_emailid);
            jdistOfficeno.setText(dist_officeno);
            jdistmobileno.setText(dist_mobileno);
            
            refreshTable(distid.toString());
        }
    }
    catch(Exception ex)
    {
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_jdistnamecomboPopupMenuWillBecomeInvisible
...
//        {
                ...
                {                                          
                        ...
                        c = (String) jDisttableproductllist.getValueAt(row, 2);
...
// add your handling code here:
    ...
    private javax.swing.JComboBox jdistnamecombo;
